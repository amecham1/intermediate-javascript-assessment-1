...
// #7  ###################
// # Implicit binding
// Make a constructor function called burrito.  It has a property called percentLeft = 100.  It has a property called eat that is a function.
//When eat is invoked it uses context to implicitly subract 25 from the percentLeft on the burrito.
...
// #9  ###################
// # Prototype 2
// Write a constructor function called chimichanga.  It has a property called percentLeft = 100.  It has a prototype function called eat.
//When eat is invoked it uses context to implicitly subract 20 from the precentLeft on the chimichanga.
...
var sentenceSmasher = function(partTwo){
...
// When addIngredient is invoked it saves that ingredient with previously added ingredients
//and then returns an object that looks like this (Replace the parts wrapped in <> with correct data):
// ```
// {
